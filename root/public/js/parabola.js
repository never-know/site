...
// 转化为整数
    ...
    Parabola.prototype = {
        ...
        initialize: function (options) {
            ...
            //this.driftY Y轴的偏移总量
            if (ops.targetEl) {
                this.driftX = parseInt(_$(ops.targetEl).offsetLeft) - this.elOriginalLeft;
                this.driftY = parseInt(_$(ops.targetEl).offsetTop) - this.elOriginalTop;
            } else {
        ...
        getOptions: function (options) {
            ...
            options = Min.obj.extend(   defaultSetting , options);
        ...
        domove: function (x, y) {
            ...
            this.el.style.left = parseInt( this.elOriginalLeft + x)+'px';
            this.el.style.top  = parseInt( this.elOriginalTop + y) +'px';
        ...
        setOptions: function (options) {
            ...
            this.options = Min.obj.extend(this.options,options);
