...
LazyLoad.prototype = {
  ...
  _initialize: function(elems, options) {
	...
	this._container = this._initContainer(_$(this.options.container));//容器
  },
  //设置默认属性
  ...
  _initContainer: function(container) {
	...
	this.load = Min.obj.methodReference(this,'_load');//$$F.bind( this._load, this );
	this.resize = Min.obj.methodReference(this,'_resize');//$$F.bind( this._resize, this );
