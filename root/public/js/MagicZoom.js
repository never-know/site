...
MagicZoom.prototype.replaceZoom = function(e, ael) {
   ...
   // if (ael.href == this.bigImage.src) return;
    ...
    newBigImage.src = ael.firstChild.getAttribute("source");
    var p = this.bigImage.parentNode;
    p.replaceChild(newBigImage, this.bigImage);
    this.bigImage = newBigImage;
    this.bigImage.style.position = 'relative';
    this.smallImage.src = ael.firstChild.getAttribute("tsImgS");
    this.safariOnLoadStarted = false;
    this.initZoom()
};
...
function MagicZoom_findZooms() {
            ...
            MagicZoom_addEventListener(aels, "click",
            function(event) {
                if (MagicZoom_ua != 'msie') {
                    this.blur()
                } else {
            ...
            bigCont.style.height = '390px';
           
            
            bigCont.style.left = aels.firstChild.width  + 'px';
        ...
        loadingImg: 'http://cdn.annqi.com/public/images/loading.gif'
            ...
            var zoom = new MagicZoom(aels.id, 'sim' + rand, bigCont.id, 'bim' + rand, settings);
            aels.mzextend = MagicZoom_extendElement;
            aels.mzextend({
                zoom: zoom
            });
            zoom.initZoom();
            MagicZoom_findSelectors(aels.id, zoom)
