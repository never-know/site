...
<title>可拖拽移动漂亮的zDialog弹出层代码_酷站代码 www.5icool.org</title>
<style>
...
<script type="text/javascript" src="http://cdn.annqi.com/public/js/zDrag.js"></script>
<script type="text/javascript" src="http://cdn.annqi.com/public/js/zDialog.js"></script>
<script type="text/javascript">
function open1()
{
	Dialog.open({URL:"http://passport.annqi.com/login/popup.html?ReturnUrl=http://cart.annqi.com/redirect.html"});
}
function open2()
{
	var diag = new Dialog();
	...
	diag.URL = "http://cart.annqi.com/add.html";
	diag.show();
}
function open3()
{
...
<ul>    <li><span style="color:rgb(255, 0, 0); ">ID</span>：窗口id号，可省略。每个窗口的id必须是唯一的不能重复。</li>
    ...
    <li><span style="color:rgb(255, 0, 0); ">URL</span>：  窗口内容页地址，或使用相对路径或绝对路径，注意如果使用<a href="#;">http://www.5icool.org</a>形式的绝对地址，则http://不能省略。</li>
...
<pre>
	...
	<font color="#800000">diag.</font><font color="#008080">URL </font><font color="#800000">= </font><font color="#ff00ff">&quot;http://www.5icool.org/&quot;</font><font color="#800000">;</font>
	<font color="#800000">diag.show();</font>
</pre>
</div>
