...
<div class="container" >
	<div class="shortcut-wrapper">
		<div class="shortcut">
			<div class="login-info">
				<span><i class="icon_black iconfont">&#xe601;</i><a href="#" >天猫首页 </a></span>
			...
			<ul>
				<li><a href="#" >天猫宝</a></li>			
				<li class="arrow-down"><a href="#" >我的淘宝</a><i class="icon_right iconfont">&#xe611;</i>
					<div>
						<p><a href="#">Chinese</a></p>
						<p><a href="#">English</a></p>
					</div>
				</li>
				<li><a href="#" ><i class="icon_black iconfont">&#xe623;</i>购物车2件</a></li>
				<li class="arrow-down"> <a href="#" >我的收藏</a><i class="icon_right iconfont">&#xe611;</i>
					<div>
						<p><a href="#">Chinese</a></p>
						<p><a href="#">English</a></p>
					</div>
				</li>
				<li><i class="icon_black iconfont">&#xe609;</i><a href="#" >手机版</a></li>
				<li><i class="icon_black iconfont">&#xe60b;</i><a href="#" >网站导航</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="header">
		...
		<div class="region"  ><span>世纪联华-金海城店</span><i class="icon iconfont hide">&#xe637;</i></div>
